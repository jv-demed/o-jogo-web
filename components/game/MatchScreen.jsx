...
/**
 * A mesa. A tela inteira da partida, do feltro ao rodape.
 *
 * Saiu da pagina do solo quando a partida do lobby passou a existir: as duas
 * desenham a mesma coisa e so discordam de onde o estado vem — memoria de um
 * lado, `matches.state` do outro. Ela nao sabe qual e qual, e nao deve saber:
 * o que recebe e `state` + `dispatch`, que e a mesma interface que o motor
